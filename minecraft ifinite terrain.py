...
grassStokeTex = load_texture('grass_14.png')
...
class BTYPE:
    ...
    REDSTONE = color.rgb(255,0,0)
    DIRT = color.rgb(255, 80,100)
...
vincent = Entity(model=chickenModel,scale=1,x=22,z=16,y=4,texture='chicken.png',double_sided=False)
